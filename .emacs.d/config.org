...
#+BEGIN_SRC emacs-lisp
  ...
  (set-frame-parameter nil 'alpha '(93 . 75))
#+END_SRC
** Czcionka
...
#+BEGIN_SRC emacs-lisp
  (use-package nyan-mode
    ...
    (nyan-mode 1))
#+END_SRC
** Pakiet =nlinum-relative=
W trybach programistycznych numeruje linie relatywnie do obecnej pozycji. Teoretycznie, w edytorze
=VIM= używa się tego do skakania pomiędzy liniami (gdzie jest to dośc proste)
#+BEGIN_SRC emacs-lisp
