...
- Zmienna systemowa =EMACS_SERVER_FILE= na =c:\home\.emacs.d\server\emacs-server-file= (a właściwie
  na unikalną nazwę pliku dla danego komputera
- =HOME= ustawione na =c:\home=
- Dla pythona =WORKON-HOME= ustawione na =c:\home\MojePliki\Python=
