...
** Visible bell
Włączamy =visible bell=. W innym przypadku Windows będzie grał wkurzający dźwięk przy różnych okazjach
#+BEGIN_SRC emacs-lisp
  (setq visible-bell t)
#+END_SRC
** Jak działa edycja
...
#+END_SRC
** Serwer Emacsa
Uruchom serwer =Emacsa=. Domyślną stroną ma być =*scratch*=.
...
#+BEGIN_SRC emacs-lisp
  ...
  (require 'dired+)
#+END_SRC
*** =dired-single= zmusza =dired= do używania tylko jednego okna (ale coś nie bardzo)
#+begin_src emacs-lisp
...
#+END_SRC
** Emoji
Konfiguracja klawiszy dla emoji powinna znaleźć się w poniżej.
=C-. prawo= - strzałka w prawo➡
=C-. lewo= - strzałka w lewo⬅
=C-. góra= - strzałka w górę⬆
=C-. dół= - strzałka w dół⬇
#+BEGIN_SRC emacs-lisp
  (use-package emojify
...
#+BEGIN_SRC emacs-lisp
    ...
    :defer 0)
#+END_SRC
*** Bufor capture z dowolnego miejsca
Należy stworzyć skrót z poleceniem
#+BEGIN_SRC shell
emacsclientw -n -e "(rg/org-capture)"
#+END_SRC
i przypisać skrót (np Ctrl+Alt+F6)
...
#+END_SRC
*** Podpakiet =org-cliplink=
Wstawia link do strony ze schowka, łącząc sie z nią i pobierając nazwę.
Przypisane do skrótu =C-c c l=
#+BEGIN_SRC emacs-lisp
...
*** Wielkości nagłówków zależnie od poziomu zagnieżdżenia
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Zmienna szerokość czcionek w =org-mode=
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Pakiet =helpful=
Dodaje wiele informacji do systemu pomocy Emacsa. [[https://github.com/Wilfred/helpful][Repozytorium]]
#+BEGIN_SRC emacs-lisp
  (use-package helpful
...
#+END_SRC
** Pakiet =all-the-icons-rich=
Pokazuje ikonki dla ivy-rich. [[https://github.com/seagle0128/all-the-icons-ivy-rich][Repozytorium]]
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Pakiet =ivy-rich=
Pokazuje więcej informacji na temat wybranych komend. Więcej informajci w [[https://github.com/Yevgnen/ivy-rich][Repozytorium]]
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Pakiet =all-the-icons-ivy=
Dodaje ikony plików do buforów ivy. [[https://github.com/asok/all-the-icons-ivy][Repozytorium]]
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Pakiet =autohotkey=
Pakiet do trybu AutoHotkey, który ma składnię plików o rozszerzeniu =.ahk=
#+BEGIN_SRC emacs-lisp
...
* Auto =tangle= tego pliku przy zapisywaniu
#+begin_src emacs-lisp
